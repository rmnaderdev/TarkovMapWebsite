...
<template>
  ...
  <p class="mt-3">
    I created this site to make it easier to navigate between Tarkov maps and to have them all in one place. I take no credit for the creation of any of these maps. All credit goes to the original map creators. 
    <b>You can find a link to their work in the bottom right corner of each map.</b>
  </p>
