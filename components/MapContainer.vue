<template>
  <ol-map v-if="image" :loadTilesWhileAnimating="true" :loadTilesWhileInteracting="true" class="w-full flex-1"
    ...
    <ol-image-layer id="xkcd" @change="onZoomChange">
      <ol-source-image-static :url="image" :imageSize="size" :imageExtent="extent" :projection="projection"
...
import type { MapCredit } from '~/models/MapDefinition';
